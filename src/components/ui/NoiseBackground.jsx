...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-2xl  p-2 backdrop-blur-sm bg-neutral-800",
        "shadow-[0px_0.5px_1px_0px_var(--color-neutral-900)_inset,0px_1px_0px_0px_var(--color-neutral-900)]",
