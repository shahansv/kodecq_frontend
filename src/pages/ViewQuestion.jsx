...
const ViewQuestion = () => {
  ...
  return (
    <>
      <div className="bg-neutral-900 rounded-2xl p-6 my-5 m-8 mx-16">
        ...
        <div className="bg-zinc-800 rounded-xl p-3">
          <h2 className="text-zinc-200">{question?.problem}</h2>
        </div>
        {question?.code && (
        ...
        {answers.length > 0 ? (
          <>
            {answers.map((eachAnswer, index) => (
              <div key={index}>
                <div className="bg-neutral-900 rounded-2xl p-6 my-5 m-8">
                  <div className="flex justify-between">
                    <div className="flex items-center gap-2 m-2">
                      <img
                      ...
                      <h4 className="text-zinc-200">
                        ...
                        <span className="text-zinc-500">
                          {userId == eachAnswer.answeredBy?._id ? "(You)" : ""}
                        </span>
                      </h4>
                    </div>
                  </div>
                  <div className="bg-zinc-800 rounded-xl p-3 mt-4">
                    <h2 className="text-zinc-200">{eachAnswer?.answer}</h2>
                  </div>
                  {eachAnswer?.code && (
                    <div className="mt-5 rounded-lg overflow-hidden">
                      <Editor
                  ...
                  <div className="flex justify-between items-end mt-5">
                    ...
                    <div>
                      {userId == eachAnswer.answeredBy?._id ? (
                        <div>
                          <button
